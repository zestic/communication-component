...
class MySqlCommunicationDefinitionRepository implements CommunicationDefinitionRepositoryInterface
{
    ...
    public function save(CommunicationDefinition $definition): void
    {
        ...
        try {
            ...
            $stmt = $this->pdo->prepare('
                ...
                ON DUPLICATE KEY UPDATE name = :name, updated_at = CURRENT_TIMESTAMP
            ');
